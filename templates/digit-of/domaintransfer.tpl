                        ...
                        <div class="panel card panel-default">
                            <div class="panel-heading card-header pb-0">
                                <h3 class="panel-title card-title font-size-24 mb-2">
                                    {lang key='orderForm.singleTransfer'}</h3>
                            </div>
                            <div class="panel-body card-body">
                                ...
                                <div class="form-group">
                                    <label for="inputAuthCode" style="width:100%;">
                                        ...
                                        <a data-toggle="tooltip" data-placement="left"
                                            title="{lang key='orderForm.authCodeTooltip'}"
                                            class="pull-right float-right"><i class="fas fa-question-circle"></i>
                                            {lang key='orderForm.help'}</a>
                                    </label>
                                ...
                                <div id="transferUnavailable"
                                    class="alert alert-warning slim-alert text-center w-hidden"></div>
