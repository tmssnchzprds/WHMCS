...
<form role="form" method="post" action="{routePath('account-contacts-save')}">
	...
	<div class="form-group form__btn__submit__group justify-content-between">	
		<div class="left__side__btns">
		...
		<div class="right__side__btns">
			...
			<input class="btn btn-primary ml-2" type="submit" name="save" value="{lang key='clientareasavechanges'}" />
		</div>
    </div>
