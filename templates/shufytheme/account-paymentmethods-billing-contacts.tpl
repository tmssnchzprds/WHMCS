<div id="innerBillingContactsContainer">
    <label class="form-check form-check-inline billing-contact-label billing-contact-0">
        <input
            type="radio"
            class="icheck-button"
            name="billingcontact"
    ...
    {foreach $client->contacts()->orderBy('firstname', 'asc')->orderBy('lastname', 'asc')->get() as $contact}
        <label class="form-check form-check-inline billing-contact-label billing-contact-{$contact->id}">
            <input
                type="radio"
                class="icheck-button"
                name="billingcontact"
