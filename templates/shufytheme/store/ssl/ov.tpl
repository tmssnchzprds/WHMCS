...
<div class="full__with__section landing-page bg-white ssl">
		...
		<div class="inner__page__content__container">
			<div class="row justify-content-center px-lg-0 px-10 mb-13">
				<div class="col-lg-8 col-11 text-center">
					<h6 class="promo__title coodiv-text-4 font-weight-700">{lang key="store.ssl.ov.title"}</h6>
					<p class="promo__sub__title coodiv-text-8 font-weight-300 mt-4">{lang key="store.ssl.ov.tagline"}</p>
		...
		<div class="inner__page__content__container">
			<div class="row justify-content-start align-items-center">
				...
				<div class="col-md-7 col-12">
					<h2 class="coodiv-text-5 font-weight-700 mb-4">{lang key="store.ssl.ov.descriptionTitle"}</h2>
					<p class="coodiv-text-9 font-weight-400">{lang key='store.ssl.shared.siteSealDescription'}</p>
					<div class="store__article__text">{lang key="store.ssl.ov.descriptionContent"}</div>
				</div>
			</div>
                ...
                <div class="col-md-4 col-6">
					<div class="shadow__card py-8 h-100">
						<div class="card__body text-center">
							...
							<h4 class="coodiv-text-7 font-weight-200">{lang key="store.ssl.useCases.loginPages"}</h4>
						</div>
					</div>
                </div>
                <div class="col-md-4 col-6">
					<div class="shadow__card py-8 h-100">
						<div class="card__body text-center">
							...
							<h4 class="coodiv-text-7 font-weight-200">{lang key="store.ssl.useCases.intranetSites"}</h4>
						</div>
					</div>
                </div>
                <div class="col-md-4 col-6">
					<div class="shadow__card py-8 h-100">
						<div class="card__body text-center">
							...
							<h4 class="coodiv-text-7 font-weight-200">{lang key="store.ssl.useCases.webmail"}</h4>
						</div>
					</div>
                </div>
            </div>
	...
	<div class="pt-14 white-bg position-relative">
		<div class="inner__page__content__container">
			<div class="row justify-content-center px-lg-0 px-10 mb-13">
				<div class="col-lg-8 col-11 text-center">
					<h2 class="coodiv-text-5 font-weight-700 mb-4">{lang key="store.ssl.ov.orgInfo"}</h2>
					<p class="coodiv-text-9 font-weight-400">{lang key="store.ssl.ov.orgInfoDescription"}</p>
				</div>
			</div>
		</div>
	</div>
