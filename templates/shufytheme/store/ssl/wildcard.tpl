		...
		<div class="inner__page__content__container">
			<div class="row justify-content-center px-lg-0 px-10 mb-13">
				<div class="col-lg-8 col-11 text-center">
					<h6 class="promo__title coodiv-text-4 font-weight-700">{lang key="store.ssl.wildcard.title"}</h6>
					<p class="promo__sub__title coodiv-text-8 font-weight-300 mt-4">{lang key="store.ssl.wildcard.tagline"}</p>
	...
	<div class="py-14 white-bg position-relative">
		<div class="inner__page__content__container">
			<div class="row justify-content-start align-items-center">
				...
				<h2 class="coodiv-text-5 font-weight-700 mb-4">{lang key="store.ssl.wildcard.descriptionTitle"}</h2>
				<p class="coodiv-text-9 font-weight-400">{lang key='store.ssl.shared.siteSealDescription'}</p>
				<div class="store__article__text">{lang key="store.ssl.ev.descriptionContent"}</div>
				</div>
			</div>
		</div>
	</div>
