<div class="login__register__sidebar d-lg-flex d-none">
	<span style="background-image: url(https://placehold.co/1000x1700);position: absolute;top: 0;bottom: 0;left: 0;right: 0;z-index: -1;background-size: cover;background-position: center center;">
