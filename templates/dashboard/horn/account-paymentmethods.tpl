...
<p>
    {if $allowCreditCard}
        <a href="{routePath('account-paymentmethods-add')}" data-role="add-new-credit-card" class="badge feat bg-prussian top-0" data-toggle="tooltip" data-placement="left" title="" data-original-title="{$LANG.paymentMethods.addNewCC}"><i class="ico-credit-card f-16"></i> </a>
    {/if}
    {if $allowBankDetails}
        <a href="{routePathWithQuery('account-paymentmethods-add', null, 'type=bankacct')}" class="badge feat bg-danger top-0" data-toggle="tooltip" data-placement="left" title="" data-original-title="{$LANG.paymentMethods.addNewBank}"><i class="ico-delete f-16"></i> </a>
    {/if}
</p>
