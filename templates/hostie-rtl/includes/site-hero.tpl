            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="rts-hero__content">
                        ...
                        <h1 class="heading aos-animate aos-init" data-aos="fade-down" data-aos-delay="500">Premium Hosting
                            Technologies
                        </h1>
                        ...
                        <div class="rts-hero__content--group">
                            <a href="{$WEB_ROOT}/clientarea.php" class="primary__btn white__bg">Get Started</a>
                            <a href="#pricing_plan_home" class="btn__zero plan__btn">Plans &amp; Pricing</a>
                        </div>
                        <p><img src="{$WEB_ROOT}/templates/{$template}/images/icon/dollar.svg" alt="">Starting from <span>$2.95</span> per month</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="rts-hero__images position-relative">
                        <img src="{$WEB_ROOT}/templates/{$template}/images/banner/server.png" alt="" class="banner-image">
                        <img src="{$WEB_ROOT}/templates/{$template}/images/banner/hosting.svg" alt="">
                        <div class="rts-hero__images--shape">
                            <div class="one top-bottom">
                                <img src="{$WEB_ROOT}/templates/{$template}/images/banner/left.svg" alt="">
                            </div>
                            <div class="two bottom-top">
                                <img src="{$WEB_ROOT}/templates/{$template}/images/banner/left.svg" alt="">
                            </div>
                            <div class="three top-bottom">
                                <img src="{$WEB_ROOT}/templates/{$template}/images/banner/top.svg" alt="">
                            </div>
                            <div class="four bottom-top">
                                <img src="{$WEB_ROOT}/templates/{$template}/images/banner/right.svg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
