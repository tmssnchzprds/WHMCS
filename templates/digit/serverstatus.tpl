<!-- Statistics -->
<div class="wdes-statistics row">
	<div class="col-md-4 col-sm-12">
		<a href="{$smarty.server.PHP_SELF}?view=open">
			<div class="wdes-block-board wdes-tile-red">
				<div class="content">
					<h1 class="text-left">{$opencount}</h1>
					<p>{$LANG.networkissuesstatusopen}</p>
				</div>
				<div class="icon"><i class="fal fa-exclamation-triangle"></i>
				</div>
			</div>
		</a>
	</div>
	<div class="col-md-4 col-sm-12">
		<a href="{$smarty.server.PHP_SELF}?view=scheduled">
			<div class="wdes-block-board wdes-tile-blue">
				<div class="content">
					<h1 class="text-left">{$scheduledcount}</h1>
					<p>{$LANG.networkissuesstatusscheduled}</p>
				</div>
				<div class="icon"><i class="fal fa-clock"></i>
				</div>
			</div>
		</a>
	</div>
	<div class="col-md-4 col-sm-12">
		<a href="{$smarty.server.PHP_SELF}?view=resolved">
			<div class="wdes-block-board wdes-tile-turquoise">
				<div class="content">
					<h1 class="text-left">{$resolvedcount}</h1>
					<p>{$LANG.networkissuesstatusresolved}</p>
				</div>
				<div class="icon"><i class="fal fa-check"></i>
				</div>
			</div>
		</a>
	</div>
...
{foreach from=$issues item=issue}
    ...
    <div class="wdes-panel-status panel {if $issue.clientaffected}panel-warning{else}panel-info{/if}">
        <div class="panel-head-wdes panel-heading">
