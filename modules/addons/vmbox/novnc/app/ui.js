...
const UI = {
    ...
    start() {
        ...
        if (autoconnect === 'true' || autoconnect == '1' || true) {
            autoconnect = true;
            UI.connect();
        } else {
            autoconnect = false;
    ...
    initSettings() {
        ...
        UI.initSetting('host', window.HOST);
        UI.initSetting('port', window.PORT);
        UI.initSetting('encrypt', window.ENCRYPT);
        UI.initSetting('view_clip', false);
        UI.initSetting('resize', 'off');
        UI.initSetting('shared', true);
        UI.initSetting('view_only', false);
        UI.initSetting('show_dot', false);
        UI.initSetting('path', window.PATH);
 ...
 * ------v------*/
    ...
    credentials(e) {
        UI.rfb.sendCredentials({ password: window.PASSWORD });
        UI.reconnect_password = window.PASSWORD;
    },
